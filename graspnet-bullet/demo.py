...
parser.add_argument('--num_view', type=int, default=300, help='View Number [default: 200]')
...
def get_and_process_data(data_dir):
    ...
    # generate cloud
    # camera = CameraInfo(1080.0, 720.0, intrinsic[0][0], intrinsic[1][1], intrinsic[0][2], intrinsic[1][2], factor_depth)
